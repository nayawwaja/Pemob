...
class _WaiterScreenState extends State<WaiterScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Penyegaran otomatis setiap 10 detik (Penyegaran Senyap) agar data selalu terbaru
  ...
  Future<void> _refreshData({bool silent = false}) async {
    ...
    try {
      // Permintaan Paralel agar lebih cepat
      ...
      if (mounted) {
        setState(() {
          ...
          if (results[0]['success'] == true) {
            ...
            // Filter hanya yang statusnya 'siap' (Siap Antar)
          ...
          if (results[1]['success'] == true) {
            ...
            // Hitung meja kotor untuk lencana notifikasi
  ...
  Future<void> _deliverOrder(Map<String, dynamic> order) async {
    // Konfirmasi dulu agar tidak tertekan
        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            SliverAppBar(
              ...
              title: const Text("Dasbor Pelayan", style: TextStyle(fontWeight: FontWeight.bold)),
              actions: [
  ...
  Widget _buildReadyListTab() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final items = order['items'] as List? ?? []; // Transmisi aman
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (item['notes'] != null && item['notes'].isNotEmpty)
                                      Text("Catatan: ${item['notes']}", style: const TextStyle(color: Colors.redAccent, fontSize: 12, fontStyle: FontStyle.italic)),
                                  ],
                                ),
                              ),
                            ],

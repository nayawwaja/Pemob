...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _checkAuth() async {
    ...
    if (token != null && userRole != null) {
      // --- LOGIKA PERUTEAN BERDASARKAN PERAN ---
      Widget nextScreen;
      ...
      switch (userRole) {
        ...
        case 'manager':
          ...
          break;
        default:
          // Cadangan jika peran tidak dikenali
          nextScreen = const StaffDashboard();
      }
      ...
      // Jika belum masuk, ke Layar Masuk
      Navigator.of(context).pushReplacement(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black, // Pastikan latar belakang hitam total
      body: Container(

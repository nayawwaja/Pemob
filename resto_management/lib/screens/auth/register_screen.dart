...
/// Layar pendaftaran akun baru untuk staf
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration:
                          _inputDecoration('Posisi Lamaran', Icons.badge),
                    ...
                    TextFormField(
                      ...
                      style: const TextStyle(
                          ...
                          letterSpacing: 1),
                      decoration:
                          _inputDecoration('Kode Akses Staff', Icons.vpn_key)
                              .copyWith(
                        hintText: 'Contoh: CHEF-8821-1200',
                        hintStyle:
                            TextStyle(color: Colors.white24, letterSpacing: 0),
                      ),
                      validator: (val) =>
                          val!.isEmpty ? 'Kode akses wajib diisi' : null,
                    ),
                    const SizedBox(height: 20),
                    ...
                    TextFormField(
                      ...
                      validator: (val) =>
                          val!.isEmpty ? 'Konfirmasi password' : null,
                    ),
                    const SizedBox(height: 40),
